...
from app.scheduler.run_once import BRISBANE_TZ, _timestamp, run_pipeline_once
...
def main() -> None:
    ...
    print(
        ...
        "Pipeline=Every minute from 09:00 to 18:00, Monday-Sunday | "
