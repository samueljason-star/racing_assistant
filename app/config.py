...
MODEL_EDGE_LATE_V1_STAKE_PCT = _get_float_env("MODEL_EDGE_LATE_V1_STAKE_PCT", 0.005)
MODEL_EDGE_LATE_V2_STAKE_PCT = _get_float_env("MODEL_EDGE_LATE_V2_STAKE_PCT", 0.005)
