...
PAPER_BANK_BASELINE = _get_float_env("PAPER_BANK_BASELINE", 10000.0)
PAPER_MIN_ODDS = _get_float_env("PAPER_MIN_ODDS", 3.0)
PAPER_MAX_ODDS = _get_float_env("PAPER_MAX_ODDS", 20.0)
PAPER_MIN_EDGE = _get_float_env("PAPER_MIN_EDGE", 0.05)
