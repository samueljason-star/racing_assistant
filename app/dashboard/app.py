      ...
      <div class="bet-list">
        ...
        <div class="bet-card">
          ...
          <div class="bet-grid">
            ...
            <div class="bet-line">Movement Score: {{ bet.movement_score or "N/A" }}</div>
            <div class="bet-line">Latest Odds Time: {{ bet.latest_odds_timestamp or "N/A" }}</div>
            <div class="bet-line">Move 10m->Now: {{ bet.movement_10_to_now or "N/A" }}</div>
            <div class="bet-line">Move 5m->Now: {{ bet.movement_5_to_now or "N/A" }}</div>
            <div class="bet-line">Move 3m->Now: {{ bet.movement_3_to_now or "N/A" }}</div>
            <div class="bet-line">Move 1m->Now: {{ bet.movement_1_to_now or "N/A" }}</div>
